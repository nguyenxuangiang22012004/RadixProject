            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-12">
                    ...
                    <div class="single-widget about">
                        ...
                        <ul class="list">
                            <?php
                            if (!empty($address)){
                                echo '<li><i class="fa fa-map-marker"></i>Địa chỉ: '.$address.'</li>';
                            }

                            if (!empty($hotline)){
                                echo '<li><i class="fa fa-headphones"></i>Hotline: '.$hotline.'</li>';
                            }
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    ...
                    <div class="single-widget twitter">
                        ...
                        <a class="twitter-timeline" data-height="300" data-theme="dark" href="<?php echo $linkTwitter; ?>?ref_src=twsrc%5Etfw">Tweets by hoanganit</a> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
                    </div>
                    <!--/ End Twitter Widget -->
                </div>
                <div class="col-lg-3 col-md-6 col-12">
