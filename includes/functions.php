...
function sendMail($to, $subject, $content)
{
    ...
    try {
        ...
        $mail->Username   = 'nguyenxuangiang22012004@gmail.com';                     //SMTP username
        $mail->Password   = 'dovl ntuv ijwc gwjh';                               //SMTP password
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
        $mail->Port       = 465;                                    //TCP

        //Recipients
        $mail->setFrom('nguyenxuangiang22012004@gmail.com', 'Hỗ trợ khôi phục');
                ...
                <div class="comment-list">
                    ...
                    <div class="body">
                        <h4><?php echo $item['name'];
                            echo !empty($item['user_id']) ? ' <span class="badge badge-danger">' . $item['group_name'] . '</span>' : false; ?></h4>
