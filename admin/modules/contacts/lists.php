                    ...
                    foreach ($listContacts as $key => $item):
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <a href="<?php echo getLinkAdmin('contacts', 'delete', ['id'=>$item['id']]); ?>" onclick="return confirm('Bạn có chắc chắn muốn xoá?')" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Xoá</a>
