                ...
                if (!empty($listAllPortfolio)):
                    ...
                    foreach ($listAllPortfolio as $item):
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="?<?php echo getLinkQueryString('cate_id', $item['cate_id']); ?>"><?php echo $item['cate_name']; ?></a>
                            </td>
                            <td>
                            ...
                            <td><a href="<?php echo getLinkAdmin('portfolios', 'delete', ['id'=>$item['id']]); ?>" onclick="return confirm('Are you sure?')" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Xoá</a></td>
                        </tr>
                    <?php endforeach; else: ?>
                    <tr>
                        <td colspan="7">
