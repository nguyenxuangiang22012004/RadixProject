                ...
                if (!empty($listSubscribe)):
                    foreach ($listSubscribe as $key => $item):
                        ...
                        <tr>
                            ...
                            <td class="text-center"><a href="<?php echo getLinkAdmin('subscribe', 'delete', ['id'=>$item['id']]); ?>" onclick="return confirm('Bạn có chắc chắn muốn xoá?')" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Xoá</a></td>
                        </tr>
                        <?php
                    endforeach;
                else:
